...
const DeckManipulatePageQtyPicker = ({card}) => {
    ...
    return (
        //make a quantity picker using card info and request and state that is held within this component
        <>
...
export default DeckManipulatePageQtyPicker